...
from models.vilmodel_cmt import NavCMT, NavTDSTP, NavScanme, NavHAMTScanme
...
def get_vlnbert_models(args, config=None):
    if args.agent_name == 'tdstp':
        model_class = NavTDSTP
    elif args.agent_name == 'scanme':
        model_class = NavScanme
    elif args.agent_name == 'hamt_scanme':
        model_class = NavHAMTScanme
    elif args.agent_name in ['seq2seq', 'hamt']:
        model_class = NavCMT
    else:
