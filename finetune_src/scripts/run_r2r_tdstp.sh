...
outdir=../datasets/vln/R2R/finetune/tdstp/vitbase_r2rfte2e-finetune_seed${seed}
rootdir=../datasets
...
# train
python r2r/main.py $flag --eval_first --agent_name tdstp \
...
# inference
python r2r/main.py $flag --agent_name tdstp \
