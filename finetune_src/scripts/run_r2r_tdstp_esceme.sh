...
outdir=../datasets/vln/R2R/finetune/tdstp_esceme/${ob_type}_${pooling}_seed${seed}
rootdir=../datasets
...
# train
python r2r/main.py $flag --eval_first --agent_name scanme \
...
# inference
python r2r/main.py $flag --agent_name scanme \
