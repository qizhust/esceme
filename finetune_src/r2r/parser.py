...
def parse_args():
    ...
    # scan memory
    parser.add_argument('--agent_name', type=str, default='seq2seq')
    parser.add_argument('--pooling', type=str, default='max', choices=['mean', 'max'], help='pooling type for node feature')
