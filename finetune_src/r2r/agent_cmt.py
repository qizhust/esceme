...
class Seq2SeqCMTAgent(BaseAgent):
    ...
    def rollout(self, train_ml=None, train_rl=True, reset=True):
        ...
        if type(self.loss) is int:  # For safety, it will be activated if no losses are added
            ...
            self.losses.append(self.loss.sum().item() / self.args.max_action_len)  # This argument is useless.
    ...
    def train(self, n_iters, feedback='teacher', **kwargs):
        ...
        for iteration in range(1, n_iters + 1):
            ...
            #print(self.rank, iteration, self.loss)
            ...
            if self.args.aug is None:
                print_progress(iteration, n_iters+1, prefix='Progress:', suffix='Complete', bar_length=50)
